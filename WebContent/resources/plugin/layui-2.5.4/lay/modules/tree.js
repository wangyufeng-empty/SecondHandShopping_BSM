        ...
        g.prototype.config = {
            ...
            g.prototype.setCheckbox = function (e, i, a) {
                ...
                if ("object" == typeof i.children || e.find("." + y)[0]) {
                    if(config.chkboxType == null || ( r == true && config.chkboxType.Y.indexOf("s") >= 0) || ( r == false && config.chkboxType.N.indexOf("s") >= 0)){
                ...
                var t = function (e) {
                    if (e.parents("." + s)[0]) {
                        if (config.chkboxType == null || ( r == true && config.chkboxType.Y.indexOf("p") >= 0) || ( r == false && config.chkboxType.N.indexOf("p") >= 0)) {
                            var i, a = e.parent("." + y),
                                n = a.parent(),
            ...
            g.prototype.setChecked = function (e) {
                ...
                a.elem.find("." + s).each(function (a, n) {
                    ...
                    if ("number" == typeof e) {
                        ...
                        i.inArray(r.toString(), e) != -1 && (l[0].checked || t.click())
                    }
                })
            },
            l.that = {},
